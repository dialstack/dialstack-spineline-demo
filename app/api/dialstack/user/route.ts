...
export async function GET() {
  try {
    ...
    // Resolve the logged-in practice's user; create one if there's no match.
    const existing = resolveAccountUser(users, email);
    ...
    // No matching user — create one for this practice.
