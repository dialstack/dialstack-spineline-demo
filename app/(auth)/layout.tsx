    ...
    <div className="py-16">
      <div className="mx-auto flex max-w-[450px] flex-col gap-6 p-3">
        <div className="mb-6 flex w-full justify-center">
          <Link href="/">
            <div className="flex items-center gap-4 text-3xl font-bold text-primary">Spineline</div>
          </Link>
        </div>
        <div className="no-scrollbar w-full rounded-xl p-5 rounded-lg border">{children}</div>
